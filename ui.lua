local library = {
    Version = "0.35",
    WorkspaceName = "_3RaFe_ Hub Premium Beta",
    flags = {},
    signals = {},
    objects = {},
    elements = {},
    ...
    configuration = {
        ...
        hideKeybindWatermark = Enum.KeyCode.RightAlt,
    ...
    colors = {
        ...
        innerBorder = Color3.fromRGB(245,77,77),
        topGradient = Color3.fromRGB(93, 89, 93),
        bottomGradient = Color3.fromRGB(29, 29, 29),
        sectionBackground = Color3.fromRGB(35, 34, 34),
        section = Color3.fromRGB(245, 171, 163),
        otherElementText = Color3.fromRGB(232, 226, 232),
        elementText = Color3.fromRGB(232, 226, 232),
        ...
        tabText = Color3.fromRGB(232, 226, 232)
    },
    gui_parent = (function()
                ...
                if getsynasset then
                    ...
                    elseif (#image > 14) and (string.sub(image, 1, 14) == "synasseturl://") then
                        local x, e = pcall(function()
                            ...
                            local fold = isfolder("./"..library.WorkspaceName)
                            if fold then
                            else
                                makefolder("./"..library.WorkspaceName)
                            end
                            fold = isfolder("./Themes")
                            if fold then
                            else
                                makefolder("./Themes")
                            end
                            fold = isfolder("./Themes/SynapseAssetsCache")
                            if fold then
                            else
                                makefolder("./Themes/SynapseAssetsCache")
                            end
                            if not fold or not isfile("./Themes/SynapseAssetsCache/" .. codename .. ".dat") then
                                local res = game:HttpGet(string.sub(image, 15))
                                if res ~= nil then
                                    writefile("./Themes/SynapseAssetsCache/" .. codename .. ".dat", res)
                                end
                            end
                            return getsynasset(readfile("./Themes/SynapseAssetsCache/" .. codename .. ".dat"))
                        end)
                        if x and e ~= nil then
                            return e
                        end
...
function library:CreateWindow(options, ...)
    ...
    if options.private then
        ...
        if windowName and #windowName > 0 and library.WorkspaceName == "_3RaFe_ Hub Premium" then
            library.WorkspaceName = convertfilename(windowName, "_3RaFe_ Hub Premium")
        end
        ...
        innerBackdrop.Visible = options.UseBackgroundImage or true
        innerBackdrop.ImageColor3 = options.ImageColor or Color3.new(1, 1, 1)
        innerBackdrop.ImageTransparency = (options.ImageTransparency or 95) / 100
        innerBackdrop.Image = options.ImageAssetID or "rbxassetid://5188904811"
    ...
    -- 	Strokefps.Color = Color3.fromRGB(68, 202, 186)
    ...
    -- 	Stroketime.Color = Color3.fromRGB(68, 202, 186)
    ...
    ----FPSSSSSS ----
        ...
        function windowFunctions:SetTitleNow(options)
            local main2 = Instance_new("Frame")
            local main22 = Instance_new("Frame")
            local mainBorder2 = Instance_new("Frame")
            local tabSlider2 = Instance_new("Frame")
            local innerMain2 = Instance_new("Frame")
            local innerMainBorder2 = Instance_new("Frame")
            local innerBackdrop2 = Instance_new("ImageLabel")
            local innerMainHolder2 = Instance_new("Frame")
            local tabsHolder2 = Instance_new("ImageLabel")
            local headline2 = Instance_new("TextLabel")
            
            main2.Name = "main2"
            main2.Parent = main
            main2.AnchorPoint = Vector2.new(0.5, 0.7)
            main2.BackgroundColor3 = library.colors.background
            main2.Transparency = 1
            -- colored[1 + #colored] = {main2, "BackgroundColor3", "background"}
            -- colored[1 + #colored] = {main2, "BorderColor3", "outerBorder"}
            main2.Position = UDim2.fromScale(0.5, 0.000000000000001)
            main2.Size = UDim2.fromOffset(500, 20)
            main22.Name = "main22"
            main22.Parent = main2
            main22.AnchorPoint = Vector2.new(0.5, 1)
            main22.BackgroundColor3 = library.colors.background
            colored[1 + #colored] = {main22, "BackgroundColor3", "background"}
            main22.BorderColor3 = library.colors.outerBorder
            colored[1 + #colored] = {main22, "BorderColor3", "outerBorder"}
            -- main22.BackgroundColor3 = library.colors.background
            main22.Transparency = 0
            -- colored[1 + #colored] = {main22, "BackgroundColor3", "background"}
            -- main22.BorderColor3 = library.colors.outerBorder
            main22.Position = UDim2.fromScale(0.5, 0.5)
            main22.Size = UDim2.fromOffset(500, 25)
            makeDraggable(main22, main)
            mainBorder2.Name = "mainBorder"
            mainBorder2.Parent = main22
            mainBorder2.AnchorPoint = Vector2.new(0.5, 0.5)
            mainBorder2.BackgroundColor3 = library.colors.background
            colored[1 + #colored] = {mainBorder2, "BackgroundColor3", "background"}
            mainBorder2.BorderColor3 = library.colors.innerBorder
            colored[1 + #colored] = {mainBorder2, "BorderColor3", "innerBorder"}
            mainBorder2.BorderMode = Enum.BorderMode.Inset
            mainBorder2.Position = UDim2.fromScale(0.5, 0.5)
            mainBorder2.Size = UDim2.fromScale(1, 1)

            tabsHolder2.Name = "tabsHolder"
            tabsHolder2.Parent = mainBorder2
            tabsHolder2.BackgroundColor3 = library.colors.topGradient
            tabsHolder2.BorderSizePixel = 0
            tabsHolder2.Position = UDim2.fromOffset(1, 1)
            tabsHolder2.Size = UDim2.new(1, -2, 0, 20)
            tabsHolder2.Image = "rbxassetid://2454009026"
            tabsHolder2.ImageColor3 = library.colors.bottomGradient
            
            headline2.Name = "headline"
            headline2.Parent = tabsHolder2
            headline2.BackgroundColor3 = Color3.new(1, 1, 1)
            headline2.BackgroundTransparency = 1
            headline2.LayoutOrder = 1
            headline2.Font = Enum.Font.Code
            local SetTitlew = options.Name or "Unnamed Watermark"
            options.Name = SetTitlew
            headline2.Text = SetTitlew or "???"
            headline2.TextColor3 = library.colors.main
            headline2.TextSize = 14
            headline2.TextStrokeColor3 = library.colors.outerBorder
            headline2.TextStrokeTransparency = 0.75
            headline2.Size = UDim2:new(textToSize(headline2).X + 4, 1)
            local SetTitle = {
                tabCount = 0,
                selected = {},
                Flags = elements
            ...
            function SetTitle:Update(options)
                local SetTitleLe = options.Name or "Unnamed Watermark"
                options.Name = SetTitleLe
                headline2.Text = (SetTitleLe and tostring(SetTitleLe)) or "???"
                headline2.Size = UDim2:new(textToSize(headline2).X + 4, 1)
            end
            return SetTitle
        end
        
        function windowFunctions:Watermark(options)
            local main1 = Instance_new("Frame")
            local mainBorder1 = Instance_new("Frame")
            local innerMain1 = Instance_new("Frame")
            local innerMainBorder1 = Instance_new("Frame")
            local innerMainHolder1 = Instance_new("Frame")
            local tabsHolder1 = Instance_new("ImageLabel")
            local tabHolderList1 = Instance_new("UIListLayout")
            local tabHolderPadding1 = Instance_new("UIPadding")
            local headline1 = Instance_new("TextLabel")
            main1.Name = "main1"
            main1.Parent = pepsiLibrary
            main1.AnchorPoint = Vector2.new(0.5, 0.5)
            main1.BackgroundColor3 = library.colors.background
            colored[1 + #colored] = {main1, "BackgroundColor3", "background"}
            main.BorderColor3 = library.colors.outerBorder
            colored[1 + #colored] = {main1, "BorderColor3", "outerBorder"}
            main1.Position = UDim2.new(0.25, -10, 0.00001, -11)
            
            mainBorder1.Name = "mainBorder"
            mainBorder1.Parent = main1
            mainBorder1.AnchorPoint = Vector2.new(0.5, 0.5)
            mainBorder1.BackgroundColor3 = library.colors.background
            colored[1 + #colored] = {mainBorder, "BackgroundColor3", "background"}
            mainBorder.BorderColor3 = library.colors.innerBorder
            colored[1 + #colored] = {mainBorder, "BorderColor3", "innerBorder"}
            mainBorder.BorderMode = Enum.BorderMode.Inset
            mainBorder.Position = UDim2.fromScale(0.5, 0.5)
            mainBorder.Size = UDim2.fromScale(1, 1)
            innerMain1.Name = "innerMain"
            innerMain1.Parent = main1
            innerMain1.AnchorPoint = Vector2.new(0.5, 0.5)
            innerMain1.BackgroundColor3 = library.colors.background
            colored[1 + #colored] = {innerMain1, "BackgroundColor3", "background"}
            innerMain.BorderColor3 = library.colors.outerBorder
            colored[1 + #colored] = {innerMain, "BorderColor3", "outerBorder"}
            innerMain1.Position = UDim2.fromScale(0.5, 0.5)
            
            innerMainBorder1.Name = "innerMainBorder"
            innerMainBorder1.Parent = innerMain1
            innerMainBorder1.AnchorPoint = Vector2.new(0.5, 0.5)
            innerMainBorder1.BackgroundColor3 = library.colors.background
            colored[1 + #colored] = {innerMainBorder1, "BackgroundColor3", "background"}
            innerMainBorder1.BorderColor3 = library.colors.innerBorder
            colored[1 + #colored] = {innerMainBorder1, "BorderColor3", "innerBorder"}
            innerMainBorder1.BorderMode = Enum.BorderMode.Inset
            innerMainBorder1.Position = UDim2.fromScale(0.5, 0.54)
            innerMainBorder1.Size = UDim2.fromScale(1.05, 2.5)
            innerMainHolder1.Name = "innerMainHolder"
            innerMainHolder1.Parent = innerMain1
            innerMainHolder1.BackgroundColor3 = Color3.new(1, 1, 1)
            innerMainHolder1.BackgroundTransparency = 1
            innerMainHolder1.Position = UDim2:fromOffset(25)
            innerMainHolder1.Size = UDim2.new(15, 0, 15, -25)
            tabsHolder1.Name = "tabsHolder"
            tabsHolder1.Parent = innerMain1
            tabsHolder1.BackgroundColor3 = library.colors.topGradient
            colored[1 + #colored] = {tabsHolder1, "BackgroundColor3", "topGradient"}
            tabsHolder1.BorderSizePixel = 0
            tabsHolder1.AnchorPoint = Vector2.new(0.5, 0.5)
            tabsHolder1.Position = UDim2.fromScale(0.5, 0.54)
            tabsHolder1.BackgroundTransparency = 1
        -- 	tabsHolder1.Image = "rbxassetid://2454009026"
            tabsHolder1.ImageColor3 = library.colors.bottomGradient
            colored[1 + #colored] = {tabsHolder1, "ImageColor3", "bottomGradient"}
            tabHolderList1.Name = "tabHolderList"
            tabHolderList1.Parent = tabsHolder1
            tabHolderList1.FillDirection = Enum.FillDirection.Horizontal
            tabHolderList1.SortOrder = Enum.SortOrder.LayoutOrder
            tabHolderList1.VerticalAlignment = Enum.VerticalAlignment.Center
            tabHolderList1.Padding = UDim:new(1)
            
            tabHolderPadding1.Name = "tabHolderPadding"
            tabHolderPadding1.Parent = tabsHolder1
            tabHolderPadding1.PaddingLeft = UDim:new(5)
            headline1.Name = "headline"
            headline1.Parent = tabsHolder1
            headline1.BackgroundColor3 = Color3.new(1, 1, 1)
            headline1.BackgroundTransparency = 1
            headline1.LayoutOrder = 1
            headline1.Font = Enum.Font.Code
            local Watermark = options.Name or "Unnamed Watermark"
            options.Name = Watermark
            headline1.Text = Watermark or "???"
            headline1.TextColor3 = library.colors.main
            colored[1 + #colored] = {headline1, "TextColor3", "main"}
            headline1.TextSize = 14
            headline1.TextXAlignment = Enum.TextXAlignment.Left
            headline1.TextStrokeColor3 = library.colors.outerBorder
            colored[1 + #colored] = {headline1, "TextStrokeColor3", "outerBorder"}
            headline1.TextStrokeTransparency = 0.75
            main1.Size = UDim2:new(textToSize(headline1).X - 50, 0, 1)
            makeDraggable(headline1, innerMain1)
            makeDraggable(tabsHolder1, innerMain1)
            makeDraggable(innerMainHolder1, innerMainHolder1)
            innerMain1.Size =UDim2:new(textToSize(headline1).X + 5, 1, -14)
            tabsHolder1.Size = UDim2:new(textToSize(headline1).X + 9, 0.6, 23)
            headline1.Size = UDim2:new(textToSize(headline).X + 4, 1)
            do
                local os_clock = os.clock
                library.signals[1 + #library.signals] = userInputService.InputBegan:Connect(function(keyCode)
                    if IgnoreCoreInputs or userInputService:GetFocusedTextBox() then
                        return
                    elseif keyCode.KeyCode == library.configuration.hideKeybindWatermark then
                        if not lasthidebingWatermark or ((os_clock() - lasthidebingWatermark) > 12) then
                            main1.Visible = not main1.Visible
                        end
                        lasthidebingWatermark = nil
                    end
                end)
            end
            local SetWatermark = {
            ...
            function SetWatermark:Update(options)
                local eaaaaa = options.Name or "Unnamed Watermark"
                options.Name = eaaaaa
                headline1.Text = (eaaaaa and tostring(eaaaaa)) or "???"
                innerMain1.Size =UDim2:new(textToSize(headline1).X + 5, 1, -14)
                tabsHolder1.Size = UDim2:new(textToSize(headline1).X + 9, 0.6, 23)
                headline1.Size = UDim2:new(textToSize(headline).X + 4, 1)
            end
        ...
        function windowFunctions:CreateTab(options, ...)
            ...
            function tabFunctions:CreateSection(options, ...)
                ...
                function sectionFunctions:AddLabelCenter(options, ...)
                ...
                sectionFunctions.NewLabelCenter = sectionFunctions.AddLabelCenter
                sectionFunctions.CreateLabelCenter = sectionFunctions.AddLabelCenter
                sectionFunctions.LabelCenter = sectionFunctions.AddLabelCenter
                sectionFunctions.TextCenter = sectionFunctions.AddLabelCenter
                function sectionFunctions:AddLabel(options, ...)
                    ...
                    -- print(objectdata.SetText)
                    -- for i,v in pairs (objectdata.Parent) do
                    -- 	print(i,v)
                    -- end
                    tabFunctions.Flags[flag], sectionFunctions.Flags[flag], elements[flag] = objectdata, objectdata, objectdata
                ...
                if isfolder and makefolder and listfiles and readfile and writefile then
                    function sectionFunctions:AddPersistence(options, ...)
                        ...
                        local common_string = "./"..library.WorkspaceName.."/" .. tostring(custom_workspace or library.WorkspaceName)
                        local function resolvelist(nofold)
                            if custom_workspace ~= options.Workspace then
                                custom_workspace = options.Workspace
                                common_string = "./"..library.WorkspaceName.."/" .. tostring(custom_workspace or library.WorkspaceName)
                            end
                            ...
                            library.signals[1 + #library.signals] = optionButton.MouseButton1Click:Connect(function()
                                if not library.colorpicker then
                                    ...
                                    if multiselect then
                                        ...
                                        if togged then
                                            table.remove(selectedOption, togged)
                                                if table.concat(selectedOption,", ") == "" then
                                                    dropdownSelection.Text = "Select Item(s)"
                                                else
                                                    dropdownSelection.Text = table.concat(selectedOption,", ")
                                                end
                                        -- dropdownSelection.Text = "Select Item ( "..table.concat(selectedOption,", ").." )"
